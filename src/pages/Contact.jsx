    ...
    <div className="h-[100vh] flex items-center justify-center py-10 bg-transparent ">
      ...
      >
        ...
        <div  className={`w-full lg:w-2/3 p-8  ${
            darkMode ? "text-white bg-[#014421]" : "text-gray-800 bg-[#FAD5A5]"
          }`}>
          <h2 className="text-3xl font-bold mb-4">Let's <span className={`${darkMode ? "text-[#FFD580]" : "text-[#E97451]"}`}>Talk</span></h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className={`w-full px-3 py-2  rounded-lg ${darkMode ? "bg-[#355E3B]": "bg-[#FAC898]"} shadow-md focus:outline-none focus:ring-2 focus:ring-white`}
              ></textarea>
            </div>
            {/* Submit Button */}
            <button
